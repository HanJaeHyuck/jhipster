...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, net.openobject.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, net.openobject.repository.UserRepository.USERS_BY_EMAIL_CACHE);

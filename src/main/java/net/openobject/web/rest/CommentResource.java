...
import net.openobject.service.CommentService;
...
/**
 * REST controller for managing {@link net.openobject.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
public class CommentResource {
    ...
    public ResponseEntity<Comment> partialUpdateComment(@RequestBody Comment comment) throws URISyntaxException {
        log.debug("REST request to update Comment partially : {}", comment);
        if (comment.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }

...
import static net.openobject.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import net.openobject.config.Constants;
import net.openobject.domain.User;
import net.openobject.repository.AuthorityRepository;
import net.openobject.repository.UserRepository;
import net.openobject.security.AuthoritiesConstants;
import net.openobject.service.UserService;
import net.openobject.service.dto.AdminUserDTO;
import net.openobject.service.dto.PasswordChangeDTO;
import net.openobject.service.dto.UserDTO;
import net.openobject.web.rest.vm.KeyAndPasswordVM;
import net.openobject.web.rest.vm.ManagedUserVM;
